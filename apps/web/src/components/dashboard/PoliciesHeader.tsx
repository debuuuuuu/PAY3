...
export function PoliciesHeader({
  ...
  useGSAP(
    ...
    { scope: root, dependencies: [sessionCount, lastDecision] }
  );
  ...
  return (
    ...
    >
      <div
        data-hero-beam
        className="overview-hero-beam pointer-events-none absolute inset-x-6 bottom-0 h-px origin-left bg-gradient-to-r from-transparent via-violet-400/35 to-transparent md:inset-x-10"
        aria-hidden
      />
      ...
      <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
        <div data-overview-block>
          ...
          >
            Dry-run MCP actions against session rules — AUTO_EXECUTE,
            PENDING_APPROVAL, or REJECTED — before agents spend for real.
          </p>
        </div>
        ...
        <div className="flex flex-wrap gap-2.5" data-overview-block>
          ...
          >
            ...
            <p className="mt-1 font-[family-name:var(--font-jetbrains-mono)] text-[11px] uppercase tracking-[0.08em] text-white/75">
              {lastDecision ?? "—"}
            </p>
          </div>
        </div>
